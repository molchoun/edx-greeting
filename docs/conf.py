...
"""
edx-greeting documentation build configuration file.
...
html_context = {
    ...
    "github_repo": 'edx-greeting',  # Repo name
...
#
html_theme_options = {
    "repository_url": "https://github.com/https://github.com/molchoun/edx-greeting",
...
#
# html_title = 'edx-greeting v0.1.0'
...
texinfo_documents = [
    (top_level_doc, project_title, documentation_title,
     author, project_title, 'API endpoint',
     'Miscellaneous'),
]
...
def on_init(app):  # pylint: disable=unused-argument
    ...
    check_call([apidoc_path, '-o', docs_path, os.path.join(root_path, 'edx_greeting'),
                os.path.join(root_path, 'edx_greeting/migrations')])
